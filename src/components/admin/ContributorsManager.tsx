            ...
            <div className="space-y-3.5 mt-4 max-h-[70vh] overflow-y-auto pr-1">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-[11px] text-stone-500">JPG, PNG, WEBP &lt; 10MB</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-14 h-14 rounded-full border border-stone-200 overflow-hidden bg-stone-100 shrink-0 relative">
                    {editingAuthor.avatarUrl ? (
                      <img
                        src={editingAuthor.avatarUrl}
                  ...
                  <div className="flex-1 space-y-2">
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="flex-1 text-xs sm:text-sm border border-stone-300 rounded-xl px-3 py-2 min-h-[44px] outline-hidden focus:border-emerald-800"
                      />
                      <input
                        type="file"
                        ref={photoInputRef}
                        ...
                        onChange={async (e) => {
                          ...
                          if (!val.valid) {
                            setPhotoError(val.error || 'Invalid image file.');
                            return;
                          }
                          ...
                          try {
                            const res = await uploadImageFile(file, {
                              folder: 'authors',
                              id: editingAuthor.id || 'new-author',
                            });
                            setEditingAuthor({ ...editingAuthor, avatarUrl: res.url });
                          } catch (err: any) {
                      ...
                      <button
                        ...
                        className="px-3 py-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-900 border border-emerald-200 rounded-xl text-xs font-semibold flex items-center gap-1.5 shrink-0 min-h-[44px] cursor-pointer"
                      >
